...
#   - New farm car: Lamborghini (346,750 CR, 40 SP to unlock 1 Super Wheelspin
...
#
# Economics (Lambo defaults): 24 cars × 346,750 CR = 8,322,000 CR per cycle.
#   999 SP cap ÷ 40 SP/car = 24 cars, 960 SP used, 39 SP carry over.
#   ~10 SP per challenge → 96 challenges per subsequent cycle.
